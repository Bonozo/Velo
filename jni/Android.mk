#BASE PATH FOR JNI
#AVPLAYER_PATH := "c:/p"
AVPLAYER_PATH := "/home/chimwemwe/android-workspace/AppVelo"

# The namespace in Java file, with dots replaced with underscores
SDL_JAVA_PACKAGE_PATH := com_bonozo_velo

# Path to shared libraries - Android 1.6 cannot load them properly, thus we have to specify absolute path here
SDL_SHARED_LIBRARIES_PATH := /data/data/com.bonozo.velo/lib

# Your application will just set current directory there
SDL_CURDIR_PATH := /data/data/com.bonozo.velo/files
